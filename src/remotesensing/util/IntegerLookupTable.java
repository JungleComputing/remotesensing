...
public class IntegerLookupTable extends LookupTable {
	...
	public IntegerLookupTable(long [] lut, long minInputValue, long maxInputValue, long minOutputValue, long maxOutputValue) {
		super();
		this.lut = lut;
